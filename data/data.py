...
class RS(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # if data_A.shape[0] != self.crop_size or data_A.shape[1] != self.crop_size or data_B.shape[0] != self.crop_size or data_B.shape[1] != self.crop_size:
        #     print("Patch size mismatch. Resampling...")
